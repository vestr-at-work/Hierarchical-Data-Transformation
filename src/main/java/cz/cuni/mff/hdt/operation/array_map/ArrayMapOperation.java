...
public class ArrayMapOperation implements Operation {
    ...
    private void matchVariablesAndArrayMapRecursive(Ur propertyUr, Ur inputUr, Ur outputUr, int iteration,
        ...
        for (var key : keys) {
            ...
            try {
                ...
                throw new OperationFailedException("Error occured when matching named variables in array-map operation");
            }
    ...
    private void parseSpec(Object spec) throws IOException {
        ...
        parsePath(pathStringTokens);
    }

    private void parsePath(String[] pathStringTokens) throws IOException {
